...
namespace FacturacionVentasWPF
{
    internal class ClaseConexionBD
    {
        ...
        {
            DataSource = "JUANCHO-LAPTOP\\SQLSERVER2019", //indico el nombre del servidor
        ...
        public static DataTable GetBusquedaCliente(int tipoId, double codId)
        {
            ...
            SqlConnection conexion = new("server=JUANCHO-LAPTOP\\SQLSERVER2019 ; database=BD_Facturacion ; integrated security = true");
            conexion.Open();
            string busquedaPor = "";
